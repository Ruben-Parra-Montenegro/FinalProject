...
public class DataEntry {
    ...
    void SaveToFileClicked(ActionEvent event) {
        ...
        try {
            ...
            String[] data = { DateInput.getValue().toString(), E1.getValue().toString(), E2.getValue().toString(),
                    ...
                    E6S4W.getText(),
                    E6S5W.getText(),
                    E6S6W.getText(), Cardiotype.getValue().toString(), CardioTime.getText()/* , add more data here */ };
            Row row = sheet.getRow(rowNum);
            if (row == null) {
